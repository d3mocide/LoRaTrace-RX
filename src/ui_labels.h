...
// redesign, docs/ROADMAP.md; docs/BRAND.md "Interface Naming").
//
// docs/BRAND.md has carried a profile/mode naming table since it was written
...
// `detections.csv` a real run has produced, and docs/DESIGN.md §8 already has a
...
//
// Revised twice 2026-08-25, same day (docs/BRAND.md's own "Revised again" note
...
// The plain, technical profile name — docs/BRAND.md: no per-profile branding,
...
// docs/BRAND.md "Interface Naming": HOME_LISTEN -> Watch. Probe is now the
