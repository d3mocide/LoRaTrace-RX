...
enum class MenuAction : uint8_t {
    ...
    // radioRequestCellSweep() comment has the full reasoning). Unlike
    // Probe/Sweep it has no dedicated global hotkey or carousel page yet —
    // reachable only from the root menu — and no result beyond a toast.
    CELL_TOGGLE,
